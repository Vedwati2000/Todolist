                ...
                bookItem.innerHTML = `
                    <div style="display: flex; align-items: center; margin-bottom: 20px; border: 1px solid #ddd; padding: 10px;">
                        ...
                        <div>
                            ...
                            <p style="margin: 5px 0;">Author: ${book.author_name ? book.author_name.join(', ') : 'Unknown'}</p>
                            <p style="margin: 5px 0;">First Published: ${book.first_publish_year || 'Unknown'}</p>
                            
                            <p style="margin: 5px 0;">Description: ${description}</p>
                        </div>
                    </div>
                `;
